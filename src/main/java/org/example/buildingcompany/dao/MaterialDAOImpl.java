...
import org.example.buildingcompany.interfaces.dao.IMaterialDAO;
...
public class MaterialDAOImpl implements IMaterialDAO {
    ...
    public void insert(Material material) throws SQLException, InterruptedException {
        ...
        statement.setInt(5, material.getSupplier().getId());
    ...
    public List<Material> findAll() throws SQLException, InterruptedException {
        ...
        while(resultSet.next()) {
            ...
            material.setSupplier(supplierDAO.findById(resultSet.getInt("suppliers_id")));
    ...
    @Override
    public Material findById(Integer id) throws SQLException, InterruptedException {
        Connection connection = ConnectionPool.getInstance().getConnection();
    ...
    @Override
    public void update(Material material, Integer id) throws SQLException, InterruptedException {
        Connection connection = ConnectionPool.getInstance().getConnection();
